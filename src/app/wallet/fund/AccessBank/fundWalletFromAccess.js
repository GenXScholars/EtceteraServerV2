...
const walletFundAccessService = require("./fundFrmAccessServices");
...
function  initiateFunding(req, res, next){
    walletFundAccessService.initiateAccessBnk(req.body)
    .then((result) => {
        res.json({
...
function validate(req, res, next){
    walletFundAccessService.validateAccessBank(req.body)
    .then((result) => {
...
async function verify(req, res, next){
    walletFundAccessService.verifyAccessBnk(req.body)
    .then((results) => {
