...
const walletFundGTBnkService = require("./fundFrmGTServices");
...
function  initiateFunding(req, res, next){
    walletFundGTBnkService.initiateGTBnk(req.body)
    .then((result) => {
        res.json({
...
function validate(req, res, next){
    walletFundGTBnkService.validateGTBnk(req.body)
    .then((result) => {
...
async function verify(req, res, next){
    walletFundGTBnkService.verifyGTBnk(req.body)
    .then((results) => {
